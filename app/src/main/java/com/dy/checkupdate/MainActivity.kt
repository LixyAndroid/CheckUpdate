...
import com.dy.checkupdate.getVersion.getLocalVersionName
        ...
        object : Thread() {
            override fun run() {
                ...
                val request = Request.Builder()
                    .url("http://dytech.tpddns.cn:23333/apk?name=install")//请求的url
                    .get()
                    .build()
    ...
    private fun dialog() {
        ...
        normalDialog.setPositiveButton(
            ...
            InstallUtils.with(this@MainActivity)
                //必须-下载地址
                .setApkUrl("http://dytech.tpddns.cn:23333//files?path=" + "${upload_fath}")
